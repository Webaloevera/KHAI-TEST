...
class MyaddTest extends React.Component{
    ...
    render(){
        ...
        return(<div className="container" style={{marginTop:'2rem'}}>
            <form style={{marginTop:'2rem'}} onSubmit={(e)=>{this.onSubmit(e)}}>
                <h4 style={{color:'#fff'}}>Введите названия теста</h4>
                ...
                {question.map(q=>{
                    return(
                        <div key={q} className="row" style={{padding:'10px', backgroundColor:'#fff'}}>
                            <h5>Вопрос №{q}</h5>
                            ...
                            <div className="row">
                                ...
                                <div className="input-field col s12">
                                    ...
                                    <label htmlFor={'textarea1'+q}>ответ 1</label>
                                </div>
                                ...
                                <div className="input-field col s12">
                                    ...
                                    <label  htmlFor={'textarea2'+q}>ответ 2</label>
                                </div>
                                ...
                                <div className="input-field col s12">
                                    ...
                                    <label  htmlFor={'textarea3'+q}>ответ 3</label>
                                </div>
