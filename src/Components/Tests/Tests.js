    ...
    render(){
        ...
        return(
            <div className="container">
                ...
                <h4 style={{color:"#fff"}}>Список тестов</h4>
                {this.props.tests.length===0&&<h6>Новых тестов нет.</h6>}
                <ul>
                    {this.props.tests&&
                ...
                {this.props.completedTest.length>0&&<div>
                    <h4 style={{color:"#fff"}}>Список Пройденных тестов</h4>
                    <ul>
                        {this.props.completedTest
                            .map((t,i)=>{
                                return <li style={{color:"green"}} className={classes.test} key={i}>{i+1}.{t.titleTest}</li>
                            })
                        }
                    </ul>
                </div>}
