...
export const getTests=()=>async(dispatch,getState)=>{
    ...
    const response = await Axios.get(`https://khai-90ff9.firebaseio.com/TestsUsers/.json`)
    const tests = await Axios.get(`https://khai-90ff9.firebaseio.com/Tests.json`)
    let mcompleted=[]
...
export const completedTest=(dataTest)=>async(dispatch,getState)=>{
    ...
    console.log(student)
    const Allusers = await Axios.get(`https://khai-90ff9.firebaseio.com/TestsUsers/${id}/.json`)
    let length=0;
    if(Allusers.data){
        length = Allusers.data.length
    }
    await Axios.put(`https://khai-90ff9.firebaseio.com/TestsUsers/${id}/${length}/.json`,{student,rating})
...
export const getTestStudentById=(id)=>async(dispatch,getState)=>{
      ...
      const response = await Axios.get(`https://khai-90ff9.firebaseio.com/TestsUsers/${id}/.json`)
       let data=[];
       if(response.data){
